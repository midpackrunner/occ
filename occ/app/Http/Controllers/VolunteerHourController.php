...
class VolunteerHourController extends Controller
{
    ...
    public function store(VolunteerHourRequest $request)
    {
    	...
    	return redirect()->action('User\UserProfileController@show', array('user_profile' => $user_profile))->with('confirm_vol_hrs', 'Your request to add ' . $vol_hr->hours . ' hours to your profile has been received.  We will review your request and contact you if there is any issues.  Thank you.'); 
    }
}
